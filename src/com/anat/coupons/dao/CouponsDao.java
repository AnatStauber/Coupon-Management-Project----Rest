...
public class CouponsDao {
	...
	public long createCoupon(Coupon coupon) throws ApplicationException {
		...
		try {
			...
			throw new ApplicationException(e, ErrorType.GENERAL_ERROR,
					"error in couponsDao: failed to create coupon " + DateUtils.getCurrentDateAndTime());
		} finally {
	...
	public void deleteCoupon(long couponId) throws ApplicationException {
		...
		try {
			...
			throw new ApplicationException(e, ErrorType.GENERAL_ERROR,
					"error in couponsDao: failed to delete coupon " + DateUtils.getCurrentDateAndTime());
	...
	public void deleteExpiredCoupons() throws ApplicationException {
		...
		try {
			...
			throw new ApplicationException(e, ErrorType.GENERAL_ERROR,
					"error in couponsDao: failed to delete expired coupons. " + DateUtils.getCurrentDateAndTime());
		} finally {
	...
	public void updateCoupon(Coupon coupon) throws ApplicationException {
		...
		try {
			...
			throw new ApplicationException(e, ErrorType.GENERAL_ERROR,
					"error in couponsDao: failed to update coupon " + DateUtils.getCurrentDateAndTime());
		} finally {
			JdbcUtils.closeResources(connection, preparedStatement);
		}
	}
	...
	public Coupon getCouponByCouponId(long couponId) throws ApplicationException {
		...
		try {
			...
			throw new ApplicationException(e, ErrorType.GENERAL_ERROR,
					"error in couponsDao: failed to get coupon by ID " + DateUtils.getCurrentDateAndTime());
		} finally {
			JdbcUtils.closeResources(connection, preparedStatement);
		}
	...
	public List<Coupon> getCouponsByType(CouponType type) throws ApplicationException {
		...
		try {
			...
			throw new ApplicationException(e, ErrorType.GENERAL_ERROR,
					"error in couponsDao: failed to get coupon by type " + DateUtils.getCurrentDateAndTime());
		} finally {
			JdbcUtils.closeResources(connection, preparedStatement);
		}
	...
	public List<Coupon> getCouponsByEndDate(String endDate) throws ApplicationException {
		...
		try {
			...
			throw new ApplicationException(e, ErrorType.GENERAL_ERROR,
					"error in couponsDao: failed to get coupons by end date. " + DateUtils.getCurrentDateAndTime());
		} finally {
			JdbcUtils.closeResources(connection, preparedStatement);
		}
	...
	public List<Coupon> getCouponsByPrices(double minPrice, double maxPrice) throws ApplicationException {
		...
		try {
			...
			throw new ApplicationException(e, ErrorType.GENERAL_ERROR,
					"error in couponsDao: failed to get coupons by prices. " + DateUtils.getCurrentDateAndTime());
		} finally {
			JdbcUtils.closeResources(connection, preparedStatement);
		}
	...
	public List<Coupon> getAllActiveCoupons() throws ApplicationException {
		...
		try {
			...
			throw new ApplicationException(e, ErrorType.GENERAL_ERROR,
					"error in couponsDao: failed to creat a list of all coupons " + DateUtils.getCurrentDateAndTime());
		} finally {
			JdbcUtils.closeResources(connection, preparedStatement);
		}
...
//						
			...
			throw new ApplicationException(e, ErrorType.GENERAL_ERROR,
					"error in couponsDao: failed to create a list of all coupons of a company " + DateUtils.getCurrentDateAndTime());
		} finally {
			JdbcUtils.closeResources(connection, preparedStatement);
		}
		return couponsList;
	...
	public List<Coupon> getAllCouponsByCompany(long companyId) throws ApplicationException {
		...
		try {
			...
			throw new ApplicationException(e, ErrorType.GENERAL_ERROR,
					"error in couponsDao: failed to create a list of all coupons of a customer " + DateUtils.getCurrentDateAndTime());
		} finally {
			JdbcUtils.closeResources(connection, preparedStatement);
		}
...
//						
			...
			throw new ApplicationException(e, ErrorType.GENERAL_ERROR,
					"error in couponsDao: failed to create a list of all active coupons of a customer " + DateUtils.getCurrentDateAndTime());
		} finally {
			JdbcUtils.closeResources(connection, preparedStatement);
		}
	...
	public void purchaseCoupon(long customerId, long couponId, int purchasedAmount) throws ApplicationException {
		...
		try {
			...
			throw new ApplicationException(e, ErrorType.GENERAL_ERROR,
					"error in couponsDao: failed to activate the purchase method " + DateUtils.getCurrentDateAndTime());
		} finally {
			JdbcUtils.closeResources(connection, preparedStatement);
		}
	}
	...
	private Coupon extractCouponFromResultSet(ResultSet resultSet) throws ApplicationException {
		...
		try {
			...
			throw new ApplicationException(e, ErrorType.DATABASE_ERROR,
					" error in couponsDao:failed to extract an instance from the resultSet " + DateUtils.getCurrentDateAndTime());
		}
		return coupon;
	}
	...
	private void updatePurchaseHistory(Connection connection, long couponId, String reason)
		...
		try {
			...
			throw new ApplicationException(e, ErrorType.GENERAL_ERROR,
					"error in couponsDao: failed to update details in purchase history. " + DateUtils.getCurrentDateAndTime());
		} finally {
			//// testttttttt
			JdbcUtils.closeResources(null, preparedStatementInsert);
			JdbcUtils.closeResources(null, preparedStatementUpdate);
