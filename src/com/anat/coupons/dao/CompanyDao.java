		...
		try {
			...
			try {
				...
				throw new ApplicationException(e1, ErrorType.DATABASE_ERROR,
						"error in CompanyDao: delete company: failed to rollback previous statements " + DateUtils.getCurrentDateAndTime());
			}
			throw new ApplicationException(e, ErrorType.GENERAL_ERROR,
					"error in CompanyDao: failed to delete company " + DateUtils.getCurrentDateAndTime());
		} finally {
